...
export function Footer({ locale }: FooterProps) {
  ...
  const orderLabel = locale === "es" ? "Ordena" : "Order";
  const rightsLabel = locale === "es" ? "Todos los derechos reservados." : "All rights reserved.";
    ...
    <footer className="site-footer">
      ...
      <div className="footer-inner">
        ...
        <div className="footer-links">
          ...
          <a href={`/${locale}${siteConfig.cloverOrderUrl}`}>
            {orderLabel}
          </a>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-copy">
            &copy; {year} Grano De Mostaza. {rightsLabel}
          </div>
